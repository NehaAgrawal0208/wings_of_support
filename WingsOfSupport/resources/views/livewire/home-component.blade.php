                        ...
                        <div class="portfolioContainer" style="margin-top: -50px;">
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                                ...
                                <a class="g-list" href="{{ route('home.service_details',['service_slug'=>$service->slug]) }}">
                                    <div class="img-hover">
                                        <img src="{{ asset('images/services/thumbnails')}}/{{ $service->thumbmail }}" alt="{{ $service->name }}"
                ...
                <div id="boxes-carousel">
                    ...
                    <div>
                        <a class="g-list" href="{{ route('home.service_details',['service_slug'=>$aservice->slug]) }}">
                            <div class="img-hover">
                                <img src="{{ asset('images/services/thumbnails')}}/{{ $aservice->thumbmail }}" alt="{{ $aservice->name }}" class="img-responsive">
                            </div>
