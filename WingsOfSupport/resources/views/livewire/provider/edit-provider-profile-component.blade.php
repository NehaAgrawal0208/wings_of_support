                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{ route('provider.profile') }}" class="btn btn-info pull-right">Profile</a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <form class="form-horizontal" wire:submit.prevent='updateProfile'>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        @elseif($image)
                                                            <img src="{{ asset('images/providers') }}/{{ $image }}" width="120">
                                                        @else
                                                            <img src="{{ asset('images/providers/1.jpg') }}" width="120">
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="service_location" class="control-label col-md-3">Service Location(pincode):</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="service_location" wire:model="service_location" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="charge" class="control-label col-md-3">Service Charge:</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="charge" wire:model="charge" />
                                                    </div>
                                                </div>
