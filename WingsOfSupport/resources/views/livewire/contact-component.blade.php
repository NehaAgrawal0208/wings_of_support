                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            @endif
                            <form name="contactform" id="contactform" class="form-theme" method="post" wire:submit.prevent='sendMessage'>
                                ...
                                <input type="submit" id="contactSubmitBtn" name="Submit" value="Send Message" class="btn btn-primary">
                            </form>
                            <div id="result"></div>
                        </div>
                    </div>
